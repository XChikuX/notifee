...
If you need to customize the generated extension further, the plugin also supports `notificationServiceExtension.name`, `bundleIdentifier`, `deploymentTarget`, `appGroupName`, `customSourceFilePath`, `entitlements`, and `infoPlist`.
